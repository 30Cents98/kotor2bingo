...
bingoList[1] = [
  { name: "Get Hanharr", types: ["Character"] },
  { name: "Get Mira", types: ["Character"] },
  { name: "Get Disciple/Handmaiden to jedi", types: ["Character," "Influence"] },
  { name: "Make Bao-Dur a jedi", types: ["Character," "Influence] },
  { name: "Force Vision", types: ["Force Power," "Influence"] },
  { name: "Implant Level 3", types: ["Character"] },
  { name: "100 Alignment", types: ["Alignment"] },
  { name: "0 Alignment", types: ["Alignment"] },
];
bingoList[2] = [
  { name: "0 influence with 1 character", types: ["Influence"] },
  { name: "Break Hanharr's Spirit", types: ["Character," "Influence"] },
  { name: "Make Mira a jedi", types: ["Character," "Influence"] },
  { name: "Go to the Rebuilt Jedi Enclave with none of the masters there", types: ["Dantooine"] },
  { name: "Kill Atris", types: ["Telos"] },
  { name: "All Unique Robes", types: ["Robes"] },
  { name: "Exactly 0 Credits", types: ["Credits"] },
  { name: "Get HK-47", types: ["Character"] },
];
bingoList[3] = [
  { name: "Complete the Sith Tomb on Korriban", types: ["Korriban"] },
  { name: "Learn Moving Meditation", types: ["Force Power, " "Influence"] },
  { name: "Get main character on title screen", types: ["Alignment"] },
  { name: "Install HK-47's unique module", types: ["Character"] },
  { name: "Defeat everyone in the Pazaak Den", types: ["Pazaak"] },
  { name: "Free Ramana", types: ["Telos"] },
  { name: "Dance for Vogga the Hutt", types: ["Nar Shaddaa"] },
  { name: "Complete all prologue quests", types: ["Ebon Hawk"] },
];
bingoList[4] = [
...
bingoList[5] = [
  ...
  { name: "Play on \"difficult"\ ", types: ["Difficulty"] },  
  { name: "Opila Crystal", types: ["Crystal"] },
  { name: "Complete the Mandalorian battle circle without violating the rules", types: ["Dxun"] },
  { name: "Complete the Handmaiden Echani battle circle", types: ["Telos"] },
  { name: "Win all swoop races", types: ["Swoop"] },  
...
bingoList[7] = [
  ...
  { name: "250 base Force Points", types: ["Crystal"] },
  { name: "Convince Vogga the Hutt to sell fuel to Telos", types: ["Nar Shaddaa"] },
  { name: "Silver Crystal", types: ["Crystal"] },
...
bingoList[8] = [
  ...
  { name: "Kill a Zakkeg", types: ["Dxun"] },
  { name: "Defeat Hanharr twice", types: ["Nar Shaddaa, " "Malachor"] },
  { name: "Kill the 2 big beasts", types: ["Onderon, " "Malachor"] },
  { name: "Complete 30 quests", types: ["Quest"] },
